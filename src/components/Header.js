...
const Header = styled.header`
  ...
  align-items: center;
  background: linear-gradient(#724c4f, #344c4f);
  ...
  render() {
    ...
    return (
      <Header id="blog-header" {...this.props}>
        {showBackButton &&
          <BackContainer>
            <NavigationButton to="https://www.zenofthecookie.com" absolute prev target="_self">
              Back to Home
            </NavigationButton>
          </BackContainer>}
        <Name className="name">
          <StyledLink to="/">
            <Last>Zen of the</Last> <First>Cookie</First>
          </StyledLink>
        </Name>
      </Header>
    )
